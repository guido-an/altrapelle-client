    ...
    <Container>
      ...
      <FooterSectionsContainer>
        <FooterSection>
          ...
          <MyLink as="a" href="mailto:servizioclienti@difar.it">
            Email: servizioclienti@difar.it
          </MyLink>
          <MyLink as="a" href="tel:+090.9912376">
            Telefono: 090.9912376
          </MyLink>
          <MyLink as="a" href="tel:800.913639">
            Numero Verde 800.913639
          </MyLink>
        </FooterSection>
        <FooterSection>
          <Title>Social</Title>
          <MyLink as="a" href="https://www.instagram.com/altrapelle/">
            Instagram
          </MyLink>
          <MyLink as="a" href="https://www.facebook.com/AltraPelle">
            Facebook
          </MyLink>
        </FooterSection>
        <FooterSection>
        ...
        <FooterSection>
          ...
          <MyLink as="a" href="/condizioni-generali-di-vendita">
            Condizioni Generali di Vendita
          </MyLink>
          <MyLink as="a" href="/privacy-policy">
            Privacy Policy
          </MyLink>
        </FooterSection>
        <FooterSection>
          ...
          <a href="https://www.vanillamarketing.it/" target="_blank" rel="noopener">
            <LogoCreditsContainer>
              <Image
                src="/footer/logo-vanilla-marketing.png"
                alt="logo Vanilla Marketing"
                width="190"
                height="68"
              />
            </LogoCreditsContainer>
